...
//!
//! Owns a single `Connection` for the lifetime of the mount. All
//! queries here are SELECTs against `sqlite_master`, PRAGMAs, or the
//! configured tables; nothing here writes, regardless of how the
...
use crate::sqlite_backend_error::BackendError;
