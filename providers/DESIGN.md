...
CollectionEntry::derived(key, files)
...
parent directories, the SDK can derive those directory effects from the path.
...
- a collection path that cannot derive the target object key;
