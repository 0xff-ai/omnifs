...
### CLI & workflow
- **Feature:** The new `omnifs ping` command checks whether the daemon is responsive and prints its uptime. (#120)
- **Fix:** Directory listings no longer omit the final entry when a page boundary falls exactly on it. (#120)
