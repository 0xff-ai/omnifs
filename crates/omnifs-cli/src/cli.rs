        ...
        match self {
            ...
            Self::Credential(args) => (
                ...
                match &args.command {
                    ...
                    commands::credential::CredentialCommand::Show(_) => "credential.show",
                    commands::credential::CredentialCommand::Rm(_) => "credential.rm",
                    commands::credential::CredentialCommand::Revoke(_) => "credential.revoke",
                },
            ),
            Self::Attachment(args) => (
                ...
                match &args.command {
                    ...
                    commands::attachment::AttachmentCommand::Restart(_) => "attachment.restart",
