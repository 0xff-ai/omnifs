...
use omnifs_auth::{AuthManifest, AuthScheme, OAuthFlow, OauthScheme, SchemeGuidance};
...
impl ProviderManifest {
    ...
    fn validate(&self) -> Result<(), ProviderMetadataError> {
        ...
        omnifs_core::ProviderName::new(self.id.as_str())
...
mod tests {
    ...
    fn checked_in_provider_manifest_schema_matches_model() {
        ...
        // exercised end-to-end by the `all_providers_initialize_and_compile` host
