...
pub fn load_registry_from_mount_dir(
    ...
    let dirs = Dirs::new(cache_dir, config_dir, providers_dir, credentials_file);
    let registry = ProviderRegistry::new(dirs, Arc::clone(&cloner)).expect("registry should load");
