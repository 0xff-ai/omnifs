...
pub(crate) const CLIENT_ID: u64 = 0x4f4d_4e49_4653_0001;
pub(crate) const SETCLIENTID_CONFIRM_VERIFIER: [u8; 8] = *b"OMNIv400";
pub(crate) const READDIR_COOKIE_VERIFIER: [u8; 8] = *b"omniDIR0";
pub(crate) const ROOT_ID: u64 = 1;
pub(crate) const EXPORT_ALIAS_ID: u64 = 2;
pub(crate) const DEFAULT_EXPORT_NAME: &str = "omnifs";
pub(crate) const OPEN_MATERIALIZE_LIMIT_BYTES: usize = 64 * 1024 * 1024;
