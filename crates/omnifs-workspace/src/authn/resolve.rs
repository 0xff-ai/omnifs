use crate::authn::scheme::{AuthManifest, AuthScheme, OauthScheme, StaticTokenScheme};
use thiserror::Error;
...
mod tests {
    use super::*;
    use crate::authn::scheme::{OAuthFlow, PkceManualCodeConfig, TokenEndpointAuthMethod};
