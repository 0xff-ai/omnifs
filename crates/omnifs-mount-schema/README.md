...
This crate is an implementation detail of the [omnifs](https://github.com/raulk/omnifs) project. Provider authors don't depend on it directly: they use `omnifs-sdk`, which re-exports the relevant types and handles the embedding via the `#[provider]` macro.
