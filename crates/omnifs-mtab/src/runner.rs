...
mod tests {
    ...
    fn record(instance: &str, id: &str, mount: &str) -> RunnerRecord {
        RunnerRecord {
            ...
            pid: 42,
            process_group: 42,
            attachment: ResourceName::new(id).unwrap(),
    ...
    fn strict_record_rejects_unknown_fields_and_invalid_instances() {
        ...
        std::fs::write(
            ...
            r#"{"version":2,"instance_id":"bad","pid":1,"process_group":1,"attachment":"main","spec":{"protocol":"nfs","runtime":"host","location":"/mnt","docker_image":null,"libkrun_guest_image":null},"control_socket":"/tmp/c","extra":true}"#,
        )
        .unwrap();
