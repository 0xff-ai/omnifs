...
/** The trailing catch-all area for bullets that match nothing else. */
export const CATCH_ALL_AREA: Area = AREAS[AREAS.length - 1]!;

export const AREA_ORDER: readonly AreaId[] = AREAS.map((a) => a.id);
