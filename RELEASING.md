...
- Docker Filesystem default: `ghcr.io/0xff-ai/omnifs-filesystem:X.Y.Z` (`crates/omnifs-fs-runtime/src/docker/container.rs`)
- libkrun Filesystem default: `ghcr.io/0xff-ai/omnifs-guest:X.Y.Z` (`crates/omnifs-fs-runtime/src/libkrun.rs`)
