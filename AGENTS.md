...
- `omnifs frontend shell <filesystem> --environment <docker|krunkit>` enters one exact observed guest frontend. Host frontends are ordinary mounted paths and need no Omnifs-owned subshell.
