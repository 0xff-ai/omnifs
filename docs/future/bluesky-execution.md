...
|---|---|---|---|---|
| PF | Preflight | — | — | done |
| T1 | Latency measurement suite | PARALLEL-OK | PF | done |
| T2 | Dogfood telemetry counters | PARALLEL-OK | PF | done |
| T3 | Benchmark harness (deterministic) | PARALLEL-OK | PF | done |
| T4 | Live benchmark + M0 report | COST, GATED | T1, T3 | todo |
| N1 | Land the phase-a deletions branch | — | PF | done |
| N2 | Characterization test net | — | N1 | done |
| N3 | Frontend concurrency net | — | N2 | done |
| M1 | omnifs-api absorbs omnifs-inspector | — | N2 | done |
| M2 | Extract omnifs-mtab | LINUX | N2 | done |
| M3 | omnifs-workspace merge | GATED(utoipa) | M1 | done |
| M4 | omnifs-engine merge + visibility | — | M3 | done |
| M5 | omnifs-auth retarget | — | M3 | done |
| U1 | Naming batch 1 (macOS-safe) | — | M4 | done |
| U2 | Naming batch 2 (Backing→Subtree) | LINUX | M4 | done |
| U3 | Strict top-level Spec parsing | GATED | M3 | todo |
| U4 | Need → AccessNeed/ResourceLimit split | — | M3, M4 | done |
| A1 | CredentialService core | — | M4, M5, N2 | done |
| A2 | Proactive refresh loop + health | — | A1 | done |
| A3 | Rejection backstop + NeedsConsent | — | A2 | pr-open (#206) |
| A4 | Revocation wiring | — | A1 | pr-open (#206) |
| A5 | device_poll_compat declared variant | — | A1 | pr-open (#205) |
| A6 | Manifest-declared ambient sources | — | A1 | pr-open (#205) |
| P1 | Structured ApiError | — | M1 | done |
| P2 | UpgradePlan::diff full binding | — | M3 | pr-open (#207) |
| P3 | Mount CRUD endpoints + Registry lock | — | P1, M3 | pr-open (#207) |
| P4 | Daemon-enforced upgrade consent | — | P2, P3 | pr-open (#207) |
...
| G1 | One inheritance function | — | M3 | done |
| G2 | Atomic writes + precedence helper + single-owner constants | PARALLEL-OK | M3 | done |
| G3 | Inject-domain ⊆ capability-need validation | — | M3 | done |
| G4 | Guest-path CI grep + Dockerfile dedup | PARALLEL-OK | PF | done |
| G5 | dev.ts through the CLI | — | C2 | todo |
| F1 | FUSE async-first dispatch | LINUX | N3 | done |
| F2 | engine::render toolkit + frontend migration | LINUX | M4, F1 | todo |
| F3 | Shared materialize cap | — | F2 | todo |
| F4 | Pagination projection face into tree | — | M4 | done |
| F5 | ServingContext + Mounts::Single removal | — | M4 | done |
| S1 | SDK P0: route export, error context, version evidence, event drops | — | N2 | done |
| S2 | router/object.rs split + ServeCtx + typed ObjectKind | — | S1 | done |
| S3 | Macro unification + helpers/pattern cleanup | — | S1 | done |
| S4 | DirProjection removal + two-stage registration | — | S2 | done |
| L1 | README/schema synthesis (D10) | — | S1 | todo |
| L2 | omnifs usage skill | — | L1 | todo |
| L3 | Staleness backstop | — | M4 | done |
| L4 | web provider | — | S1 | todo |
| L5 | GitHub deepening | — | S1 | todo |
| W1 | Worldview v0 | GATED | F5, P3, C3 | todo |
| W2 | Replica snapshot + export | — | M4 | done |
